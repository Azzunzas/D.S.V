...
public class MesasController : Controller
{
    ...
    [HttpPost]
    [Route("CadastroMesas")]
    public async Task<ActionResult> Cadastrar(Mesa mesas)
    {
    ...
    [HttpGet]
    [Route("MostrarMesas")]
    public async Task<ActionResult<IEnumerable<Mesa>>> ListarM()
    {
        if (_dbContext is null) return NotFound();
        if (_dbContext.Mesas is null) return NotFound();
    ...
    [HttpGet]
    [Route("BuscarMesa")]
    public async Task<ActionResult<Mesa>> BuscarB(int id)
    {
